...
Ext.onReady(function() {
    ...
    function xmlLink(val,meta,rec) {
        return '<Cell ss:HRef="' + val + '"><Data ss:Type="String">' + rec.get('company') + '</Data></Cell>';
    }
    ...
    function xmlImage(val,meta,rec) {
        return '<Cell ss:StyleID="Default"><![CDATA[<img src="' + val + '" height="22" alt="' + rec.get('company') + '"/>]]></Cell>';
    }
    ...
    var grid = Ext.create('Ext.grid.Panel', {
        ...
        height: 350,
        width: 600,
        title: 'Array Grid for Exporting',
